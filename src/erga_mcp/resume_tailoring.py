...
def _tailor_skills(
    ...
    *,
    ...
    def replacement(match: re.Match[str]) -> str:
        ...
        changed = changed or [item[0] for item in selected] != list(range(len(values)))
        ...
        return (
            match.group("prefix") + ", ".join(item[1] for item in selected) + match.group("suffix")
        )
...
def create_automatic_resume_proposal(
    *,
    ...
    # Generated factual templates contain a superset of approved content. Select the requested
